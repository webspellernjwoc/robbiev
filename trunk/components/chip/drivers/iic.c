 ...
 *  \return none
 */ 
void csi_iic_read_nbyte(csp_i2c_t *ptIicBase,uint32_t wdevaddr, uint32_t wReadAdds, uint8_t byReadAddrNumByte,volatile uint8_t *pbyIicData,uint32_t wNumByteRead)
{
	uint16_t hwEerorCont=0;
	uint32_t i;
	uint8_t byreadnum = 0;
